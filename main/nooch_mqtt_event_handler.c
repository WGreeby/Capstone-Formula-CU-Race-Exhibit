...
void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        msg_id = esp_mqtt_client_publish(client, "xbutton", "-60", 0, 0, 0);
        ESP_LOGI(TAG2, "sent publish successful, msg_id=%d", msg_id);
    ...
    case MQTT_EVENT_ERROR:
        ...
        break;
    case MQTT_EVENT_BOOST:
        ESP_LOGI(TAG2, "Should be working");
        ESP_LOGI(TAG2, "MQTT_EVENT_BOOST");
        msg_id = esp_mqtt_client_publish(client, "boost", "1", 0, 0, 0);
        ESP_LOGI(TAG2, "sent publish successful, msg_id=%d", msg_id);
        break;
    default:
